	...
	<section>
		...
		<table class="table_invoiceFormat">
			...
			<tr>
				...
				<td> <?php echo number_format($row_selectManOrderItems['pro_price'],0); ?> </td>
				<td> <?php echo $row_selectManOrderItems['quantity']; ?> </td>
				<td> <?php echo number_format($row_selectManOrderItems['quantity']*$row_selectManOrderItems['pro_price'],0); ?> </td>
			</tr>
			<?php $i++; } ?>
