	...
	<section>
		...
		<table class="table_invoiceFormat">
			...
			<tr>
				...
				<td> <?php echo number_format($row_selectOrderItems['pro_price'],0); ?> </td>
				<td> <?php echo $row_selectOrderItems['q']; ?> </td>
				<td> <?php echo number_format($row_selectOrderItems['q']*$row_selectOrderItems['pro_price'],0); ?> </td>
			</tr>
			<?php $i++; } ?>
			<tr style="height:40px;vertical-align:bottom;">
				...
				<?php
					...
					echo number_format($row_selectOrderItems['total_amount'],0);
				?>
				</td>
			</tr>
		</table>
